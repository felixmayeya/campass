 ...
 */
 ;(function() {
	...
	$.fn.glDatePicker.defaults =
	{
		...
		onHide: function(calendar) { calendar.show(); },
	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var prevCell = $('<div class="prevArrow"/>')
								.addClass(monyearClass)
								.css(
									$.extend({}, cellCSS,
									{
										height: cellHeight-8 + 'px',
										lineHeight: cellHeight-7 + 'px',
				...
				var prevYearCell = $('<div class="yearPrevArrow"/>')
								.addClass(monyearClass)
								.css(
									$.extend({}, cellCSS,
									{
								...
								.click(function(e) {
									if(options.nextArrow != '' && showNext) {
										e.stopPropagation();
										var select = document.getElementsByClassName("yearSelect")[0];  
										var nextYear =parseInt(yearSelect.val())-1;  
										...
										$(".titleYear>span").html(yearSelect.val());
										onYearMonthSelect();
									}
								});
				...
				var titleCell = $('<div/>')
								.addClass(monyearClass + 'title'+' monTitle')
								.css(
									$.extend({}, cellCSS,
									{
										width: titleWidth+ 'px',
										height: cellHeight-8 + 'px',
										lineHeight: cellHeight-7.5 + 'px',
										borderTopWidth: borderSize
									})
								);
				var titleCellYear = $('<div/>')
								.addClass(monyearClass + 'title'+' yearTitle')
								.css(
									$.extend({}, cellCSS,
									{
										width: titleWidth+ 'px',
				...
				var nextCell = $('<div class="nextArrow"/>')
								.addClass(monyearClass)
								.css(
									$.extend({}, cellCSS,
									{
				...
				var nextYearCell = $('<div class="yearNextArrow"/>')
								.addClass(monyearClass)
								.css(
									$.extend({}, cellCSS,
									{
...
//				};
				...
				// Build year selector
				var yearSelect = $('<select class="yearSelect"/>')
									.hide()
									.change(onYearMonthSelect);
...
//										toggleYearMonthSelect(true);
				...
				var titleYear = $('<div class="titleYear" />')
										.append(yearText)
										.append(yearSelect);
				var titleMonth = $('<div class="titleMonth" />')
										.append(monthText)
										.append(monthSelect);
				// Add to title
				titleCell.children().remove();
				titleCellYear.append(titleYear);
				titleCell.append(titleMonth);
