function brBtn(chart, smChart) {
    pageName = "BR";
    btnUrl = "/api/browser.open";
    ...
    moreDateMark = 0;
    chartType = "vBar";
    chartTxt = [Dynamic.analysis_step, Dynamic.analysis_br, Dynamic.analysis_ViewNum];

    localStorage.setItem("CHART_DATA", '')

    var paginationArr = Dynamic.analysis_br_paginationArr;
    if (swiper) {
        ...
        onSlideChangeStart: function(swiper) {
            ...
            if (swiper.activeIndex == 0 && chartTime[swiper.activeIndex] != currentChartTime) {
                var vBarChart = new chart.Chart($(".echarts_vBar"), {
                    type: 'hbarplot',
                    title: Dynamic.homeCharts_title19
                })
